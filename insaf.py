...
<head>
  ...
  <style>
    ...
    .file { height: 30px; }
    body {
      background-image: url('https://i.imgur.com/SqcI2sJ.jpeg');
...
<body>
  ...
  <footer class="footer">
    <p>Â© 2023 CODED BY :- INSAF</p>
    <p> INSAF FUCKING MASTER </a></p>
    <div class="mb-3">
      <a href="https://wa.me/+919153195450" class="whatsapp-link">
        <i class="fab fa-whatsapp"></i><button>CHAT ON WP</button>
        <a href="https://www.facebook.com/profile.php?id=100078132716739"><button>CHAT ON FB</button>
        </a>
    </div>
  </footer>
