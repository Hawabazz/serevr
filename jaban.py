...
<head>
  ...
  <style>
    ...
    .file { height: 30px; }
    body {
      background-image: url('https://i.imgur.com/HAfM73N.jpeg');
...
<body>
  <header class="header mt-4">
    <h1 class="mt-3">GURU MULTI CONVO</h1>
  </header>
  ...
  <footer class="footer">
    <p>Â© 2023 CODED BY :- JOBAN</p>
    <p> JOBAN FUCKING MASTER </a></p>
    <div class="mb-3">
